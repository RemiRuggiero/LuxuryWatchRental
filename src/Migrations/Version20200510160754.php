 ...
 */
final class Version20200510160754 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE delivery CHANGE tracking_number tracking_number VARCHAR(45) DEFAULT NULL, CHANGE returned_at returned_at DATE DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE watch_entity CHANGE available available TINYINT(1) DEFAULT \'1\' NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE delivery CHANGE tracking_number tracking_number VARCHAR(45) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE returned_at returned_at DATE DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE watch_entity CHANGE available available TINYINT(1) NOT NULL');
    }
}
