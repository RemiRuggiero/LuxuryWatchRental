 ...
 */
final class Version20200508183150 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE delivery CHANGE tracking_number tracking_number VARCHAR(45) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE returned_at returned_at DATE NOT NULL');
