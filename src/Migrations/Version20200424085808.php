 ...
 */
final class Version20200424085808 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE picture ADD watch_model_id INT DEFAULT NULL, CHANGE picture picture VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE picture ADD CONSTRAINT FK_16DB4F89108A8B86 FOREIGN KEY (watch_model_id) REFERENCES watch_model (id)');
        $this->addSql('CREATE INDEX IDX_16DB4F89108A8B86 ON picture (watch_model_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_16DB4F89108A8B86 ON picture');
        $this->addSql('ALTER TABLE picture DROP watch_model_id, CHANGE picture picture VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
